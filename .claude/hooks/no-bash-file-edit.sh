...
# ce qu'il sait faire seul : git, npm, npx, builds, migrations, mesures,
# pipelines.
...
Bash reste libre pour git, npm, npx, builds, migrations, mesures et pipelines.
EOF
  exit 2
}
...
# --- Heredoc vers un interpreteur : le motif exact utilise pour reecrire des
