...
/**
 * Panneau d'urgence, ouvert par le SOS du suivi (R10, brief §10).
 *
 * Deux voies volontairement distinctes : l'alerte previent les contacts en un
 * geste, l'appel direct passe par le telephone. Si l'alerte echoue, l'appel
 * reste sous les yeux du passager — c'est le sens de leur cohabitation (R8).
 *
 * NOTE : panneau dedie a la feature `ride` (R16).
 */
    ...
    >
      ...
      >
        ...
        {step === 'sent' ? (
          <View style={styles.sentBox}>
            ...
            <Text style={styles.sentText}>
              Vos contacts ont été prévenus avec votre position et les
        ...
        <Pressable
          ...
          style={styles.row}
          accessibilityRole="button"
          accessibilityLabel="Appeler l’assistance VORA"
        >
          <Ionicons name="headset-outline" size={18} color={colors.text} />
          <View style={styles.rowBody}>
            <Text style={styles.rowTitle}>Assistance VORA</Text>
            <Text style={styles.rowMeta}>Disponible pendant la course</Text>
          </View>
        </Pressable>
