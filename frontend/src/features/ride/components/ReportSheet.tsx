...
/**
 * Signalement d'un chauffeur (R10, brief §10).
 *
 * Les motifs sont une liste fermee : elle se traite automatiquement cote
 * back-office et evite au passager de formuler lui-meme un fait desagreable. Le
 * commentaire reste facultatif — l'exiger dissuaderait de signaler.
 *
      ...
      >
        <View style={styles.sentContent}>
          ...
          <Text style={styles.sentBody}>
            ...
            relation avec ce chauffeur en attendant.
          </Text>
          <Pressable
            onPress={onClose}
            style={styles.submit}
          ...
          {REPORT_REASONS.map((item) => {
            ...
            return (
              <Pressable
                ...
                accessibilityLabel={REPORT_REASON_LABELS[item]}
              >
                <Text
                  style={[
                    styles.reasonLabel,
